/* ecrab.c
 *  Anyone could make this. Works 
 *  Usage: ./ec <filename>
 *      Ex: ./ec testfile.c
 *  Starts in NORMAL mode.
 *      Press 'i' to enter insert mode.
 *      Press ESC to enter normal mode.
 *  In normal mode, you may use arrow keys and/or hjkl to navigate.
 *  In insert mode, navigation must be done with the arrow keys.
 *  Ctrl-S saves the file.      (both normal/insert)
 *  Ctrl-Q quits the program.   (both normal/insert)
*/
...
void editorUpdateSyntax(erow* row)
{
    ...
    char* scs = E.syntax->slcstart;
    char* mcs = E.syntax->mlcstart;
    char* mce = E.syntax->mlcend;
...
int editorSyntaxToColor(int hl)
{
    switch (hl) {
        case HL_COMMENT: 
        case HL_MLCOMMENT: return 30;   // 36: teal/cyan
        case HL_KEYWORD1: return 93;    // 33: blue
        case HL_KEYWORD2: return 91;    // 32: blue
        case HL_STRING: return 35;      // greenish
        case HL_NUMBER: return 31;      // blueish
        case HL_MATCH: return 34;       // green
        default: return 37;
    }
}
...
int main(int argc, char* argv[]) {
    ...
    editorSetStatusMessage("--NORMAL-- | HELP: Ctrl-S = save | Ctrl-Q = quit");
